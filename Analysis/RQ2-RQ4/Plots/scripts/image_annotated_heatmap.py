...
def heatmap(data, row_labels, col_labels, ax=None,
            cbar_kw={}, cbarlabel="", row_title="", col_title="", **kwargs):
    """
    ...
    **kwargs
    ...
    # Axes title
    ax.xaxis.set_label_text(row_title, fontsize=12, fontweight="bold")
    ax.yaxis.set_label_text(col_title, fontsize=12, fontweight="bold")
