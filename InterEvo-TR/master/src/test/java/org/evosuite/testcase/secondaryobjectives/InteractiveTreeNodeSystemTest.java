...
public class InteractiveTreeNodeSystemTest extends SystemTestBase {

	@Test
	public void testTreeNodeClass() {
		
		/*** TO BE CONFIGURED ****/
		
		Properties.INTERACTIVE_DIR = "/home/pedro/Documentos/InteractiveEvoSuite/Class-TreeNode";	//DIRECTORY USED FOR INTERACTION AND OUTPUT  	
		...
		Properties.GLOBAL_TIMEOUT 		= 1700;	//25 minutes + 3 minutes (additional)				
		...
		String targetClass = TreeNode.class.getCanonicalName();
