...
public class TestCaseSecondaryObjective {
    ...
    public static void setSecondaryObjectives() {
		...
		//LoggingUtils.getEvoLogger().info("* " + ClientProcess.getPrettyPrintIdentifier() + "LONGITUD DE SEC_OBJS: " + sec_objs.length + ", de PROPERTIES: " + Properties.SECONDARY_OBJECTIVE.length);
