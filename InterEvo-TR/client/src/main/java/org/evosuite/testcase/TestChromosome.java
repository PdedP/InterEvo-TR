...
public final class TestChromosome extends AbstractTestChromosome<TestChromosome> {
    ...
    public TestChromosome clone() {
        ...
        // ADDED
        c.setPreferred(this.isPreferred());
    ...
    public int compareSecondaryObjective(TestChromosome o) {
        int objective = secondaryObjIndex;	/*ADDED*/
        int c = 0;
    ...
    public static List<SecondaryObjective<TestChromosome>> getSecondaryObjectives() {
    	/*ADDED*/ 
    	List<SecondaryObjective<TestChromosome>> enabledObjectives = new ArrayList<>();
    	
    	if(isFirstSecondaryObjectiveEnabled()) {
    		return secondaryObjectives;
    	}
    	else {
    		enabledObjectives.addAll(secondaryObjectives);
    		enabledObjectives.remove(0);
    		if(!isSecondSecondaryObjectiveEnabled()) {
    			enabledObjectives.remove(0);
    		}
    	}
	...
	/* ADDED */
	public static boolean isSecondSecondaryObjectiveEnabled(){
		return secondaryObjIndex <= 1;
	}
	
	/* ADDED */ 
	public static void disableSecondSecondaryObjective() {
		if (secondaryObjIndex < 2)
			secondaryObjIndex = 2;
	}
	
	/* ADDED */
	public static void enableSecondSecondaryObjective() {
		if (secondaryObjIndex > 1)
			secondaryObjIndex = 1;
	}
