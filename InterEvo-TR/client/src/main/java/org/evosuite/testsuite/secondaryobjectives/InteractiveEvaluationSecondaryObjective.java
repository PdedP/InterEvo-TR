 ...
 * @author Pedro D.P.
 */
public class InteractiveEvaluationSecondaryObjective extends SecondaryObjective<TestSuiteChromosome> {

	private static final long serialVersionUID = 1974099736891048617L;

	//TODO: now is using readabilityValue instead of readabilityValues
	private int getReadabilitySum(TestSuiteChromosome chromosome1,
	...
	public int compareGenerations(TestSuiteChromosome parent1, TestSuiteChromosome parent2,
		...
		return getReadabilitySum(parent1, parent2)
		        - getReadabilitySum(child1, child2);
	}
