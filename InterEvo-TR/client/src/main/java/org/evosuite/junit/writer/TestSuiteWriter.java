...
public class TestSuiteWriter implements Opcodes {
     ...
     */
    public List<File> writeTestSuite(String name, String directory, List<ExecutionResult> cachedResults, boolean onlyToShow) throws IllegalArgumentException {
        ...
        if(!onlyToShow)
        	dir = TestSuiteWriterUtils.makeDirectory(directory);
        else
        	dir = directory;
