...
public abstract class TestSuiteAdapter<A extends GeneticAlgorithm<TestChromosome>>
    ...
    /*ADDED*/
    @Override
    final protected void disableFirstSecondaryCriterionTestChromosome() {
        algorithm.disableFirstSecondaryCriterionTestChromosome();
    }
    
    @Override
    final protected void enableFirstSecondaryCriterionTestChromosome() {
        algorithm.disableFirstSecondaryCriterionTestChromosome();
    }
    //
