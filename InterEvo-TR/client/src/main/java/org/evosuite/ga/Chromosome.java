...
public abstract class Chromosome<T extends Chromosome<T>>
	...
	/* ADDED */
	/** Values of readability assigned by a tester in interactions */
	private Integer readabilityValue = 0;
	//
...
//				 || ( value < 0 ) || ( ff == null ))
	...
	public Integer getReadabilityValue() {
		return readabilityValue;
	}

	public void setReadabilityValue(Integer readabilityValue) {
		this.readabilityValue = readabilityValue;
	}
