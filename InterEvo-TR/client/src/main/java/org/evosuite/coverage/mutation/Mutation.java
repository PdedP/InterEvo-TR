...
public class Mutation implements Comparable<Mutation> {
	...
	public String toStringInteractive() {
		...
		/*String type = mutationName.substring(0,mutationName.indexOf(" "));
		String mutation = "";	
		
		if(type.equals("ReplaceComparisonOperator"))
			mutation = type;
		else
			mutation = mutationName;*/
		
		String mutation = mutationName.substring(0,mutationName.indexOf(" "));
