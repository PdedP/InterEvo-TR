...
public class TestSuiteGeneratorHelper {
    ...
    public static void addAssertionsInteractive(org.evosuite.testcase.TestCase test) {
	    SimpleMutationAssertionGenerator smag = new SimpleMutationAssertionGenerator();
	    
	    ContractChecker.setActive(false); //Con esto tengo muchas dudas. Pero lo que he hecho es poner al final a true por si acaso.
	   
	    Set<Integer> tkilled = new HashSet<>();
	    smag.addAssertions(test,tkilled);
