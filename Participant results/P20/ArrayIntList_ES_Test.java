...
public class ArrayIntList_ES_Test extends ArrayIntList_ES_Test_scaffolding {
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        arrayIntList0.set((-198), (-3483));
        fail("Expecting exception: IndexOutOfBoundsException");
      
      } catch(IndexOutOfBoundsException e) {
         //
         // Should be at least 0 and less than 0, found -198
         //
         verifyException("com.org.apache.commons.collections.primitives.ArrayIntList", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        arrayIntList0.add(1607, 2742);
        fail("Expecting exception: IndexOutOfBoundsException");
      
      } catch(IndexOutOfBoundsException e) {
         //
         // Should be at least 0 and at most 0, found 1607
         //
         verifyException("com.org.apache.commons.collections.primitives.ArrayIntList", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        arrayIntList0.add((-2603), (-2603));
        fail("Expecting exception: IndexOutOfBoundsException");
      
      } catch(IndexOutOfBoundsException e) {
         //
         // Should be at least 0 and at most 0, found -2603
         //
         verifyException("com.org.apache.commons.collections.primitives.ArrayIntList", e);
      }
  }
  ...
  public void test17()  throws Throwable  {
      ...
      try {
        arrayIntList0 = new ArrayIntList((-2297));
