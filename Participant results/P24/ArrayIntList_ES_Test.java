...
public class ArrayIntList_ES_Test extends ArrayIntList_ES_Test_scaffolding {
  ...
  public void test05()  throws Throwable  {
      ...
      try { 
        arrayIntList0.removeElementAt(4);
  ...
  public void test08()  throws Throwable  {
      ArrayIntList arrayIntList0 = new ArrayIntList(0);
      arrayIntList0.add(0);
      arrayIntList0.add(0, (-4857));
      int int0 = arrayIntList0.removeElementAt(0);
      assertEquals(1, arrayIntList0.size());
      assertEquals((-4857), int0);
  }
  ...
  public void test10()  throws Throwable  {
      ArrayIntList arrayIntList0 = new ArrayIntList(0);
      arrayIntList0.add(634);
      assertEquals(1, arrayIntList0.size());
      
      int int0 = arrayIntList0.set(0, 3307);
  ...
  public void test11()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        arrayIntList0.add(3357, 3357);
        fail("Expecting exception: IndexOutOfBoundsException");
      
      } catch(IndexOutOfBoundsException e) {
         //
         // Should be at least 0 and at most 0, found 3357
         //
         verifyException("com.org.apache.commons.collections.primitives.ArrayIntList", e);
      }
  }
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        arrayIntList0.add((-1613), 3018);
        fail("Expecting exception: IndexOutOfBoundsException");
      
      } catch(IndexOutOfBoundsException e) {
         //
         // Should be at least 0 and at most 0, found -1613
         //
         verifyException("com.org.apache.commons.collections.primitives.ArrayIntList", e);
      }
  }
  ...
  public void test13()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        arrayIntList0.removeElementAt((-4857));
        fail("Expecting exception: IndexOutOfBoundsException");
      
      } catch(IndexOutOfBoundsException e) {
         //
         // Should be at least 0 and less than 0, found -4857
         //
         verifyException("com.org.apache.commons.collections.primitives.ArrayIntList", e);
      }
  }
  ...
  public void test15()  throws Throwable  {
      ...
      try {
        arrayIntList0 = new ArrayIntList((-382));
